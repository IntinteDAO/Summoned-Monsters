function c1153.initial_effect(c)
	...
	e5:SetDescription(aux.Stringid(1153,0))
	e5:SetCategory(CATEGORY_TODECK)
	e5:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e5:SetCode(EVENT_TO_GRAVE)
	e5:SetTarget(c1153.tdtg)
	e5:SetOperation(c1153.tdop)
	c:RegisterEffect(e5)
end
...
function c1153.tdtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsRelateToEffect(e) end
	Duel.SetOperationInfo(0,CATEGORY_TODECK,e:GetHandler(),1,0,0)
end
function c1153.tdop(e,tp,eg,ep,ev,re,r,rp)
