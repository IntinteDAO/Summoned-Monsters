function c1211.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c1211.target)
	e1:SetOperation(c1211.activate)
	c:RegisterEffect(e1)
end
function c1211.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c1211.activate(e,tp,eg,ep,ev,re,r,rp)
