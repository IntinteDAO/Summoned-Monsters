function c1114.initial_effect(c)
	...
	e4:SetTarget(c1114.distarget)
	c:RegisterEffect(e4)
end
function c1114.distarget(e,c)
	return c~=e:GetHandler() and c:IsType(TYPE_TRAP)
end
function c1114.disop(e,tp,eg,ep,ev,re,r,rp)
