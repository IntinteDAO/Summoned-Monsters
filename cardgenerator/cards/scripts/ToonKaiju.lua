function c1167.initial_effect(c)
	...
	e1:SetOperation(c1167.atklimit)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	...
	e4:SetCondition(c1167.sdescon)
	e4:SetOperation(c1167.sdesop)
	c:RegisterEffect(e4)
	--direct attack
...
function c1167.dirfilter1(c)
	return c:IsFaceup() and c:IsCode(1061)
end
function c1167.dirfilter2(c)
	return c:IsFaceup() and c:IsType(TYPE_TOON)
end
function c1167.dircon(e)
	return Duel.IsExistingMatchingCard(c1167.dirfilter1,e:GetHandlerPlayer(),LOCATION_ONFIELD,0,1,nil)
		and not Duel.IsExistingMatchingCard(c1167.dirfilter2,e:GetHandlerPlayer(),0,LOCATION_MZONE,1,nil)
end
