...
function c1030.operation(e,tp,eg,ep,ev,re,r,rp)
	local rg=Duel.GetMatchingGroup(c1030.filter,tp,LOCATION_MZONE,LOCATION_MZONE,nil)
...
function c1030.sp(e,tp,ct)
	...
	g=g:Filter(c1030.spfilter,nil,e,tp)
